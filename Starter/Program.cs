/*
    ...
    How it works:
    1. The first 5 tasks are the main exams.
    2. Any extra tasks are "bonus points" (only 10% of their score is added).
    3. The final score is the total sum divided by the number of main exams (5).
    4. Finally, it shows the student's name, their average score, and their letter grade (A, B, C, etc.).
*/
